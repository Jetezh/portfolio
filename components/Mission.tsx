...
const Mission = () => {
  return (
    <div className='flex flex-2/5 flex-col justify-center gap-3 lg:gap-8 md:gap-5 bg-[var(--card-color)] backdrop-filter backdrop-blur-lg lg:rounded-3xl md:rounded-2xl rounded-xl py-3 px-3 lg:py-8 lg:px-10 md:py-5 md:px-8'>
